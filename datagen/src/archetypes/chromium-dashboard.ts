...
const archetype: AppArchetype = {
  ...
  urls: { "https://app.metrico.io/overview": "overview", "https://app.metrico.io/reports": "reports" },
  screens: {
    overview: makeScreen({
      key: "overview",
      title: "Overview",
      ...
      rows: [
        ...
        { key: "reports-link", label: "View Reports", role: "link", identifier: "nav-reports", navigatesTo: "reports" },
        { key: "settings-link", label: "Settings", role: "link", identifier: "nav-settings", navigatesTo: "settings" },
        { key: "export", label: "Export CSV", role: "button", identifier: "export-btn", revealedByScroll: true },
      ],
    }),
    reports: makeScreen({
      key: "reports",
      ...
      heading: "Reports",
      rows: [
        { key: "report-traffic", label: "Traffic Sources", role: "link", identifier: "report-traffic", navigatesTo: "reportDetail" },
        { key: "report-funnel", label: "Conversion Funnel", role: "link", identifier: "report-funnel", navigatesTo: "reportDetail" },
    ...
    reportDetail: makeScreen({
      ...
      rows: [
        ...
        { key: "back-reports", label: "Back to Reports", role: "link", identifier: "back-reports", navigatesTo: "reports" },
      ],
    }),
    settings: makeScreen({
      key: "settings",
      ...
      heading: "Settings",
      rows: [
        { key: "theme", label: "Dark theme", role: "switch", identifier: "theme-toggle", togglesState: "darkTheme" },
        { key: "email-field", label: "Notification email", role: "field", identifier: "email-input", textField: "email" },
