  ...
  screens: {
    home: makeScreen({
      ...
      rows: [
        ...
        },
        {
          ...
          navigatesTo: "product",
          firesRequest: req("GET", "/api/products/101", 200, 3120),
        },
        {
          key: "prod-102",
          label: "Mechanical Keyboard",
          component: "ProductCard",
          identifier: "product-102",
          navigatesTo: "product",
          firesRequest: req("GET", "/api/products/102", 200, 2890),
        },
        {
          key: "prod-103",
          label: "USB-C Hub",
          component: "ProductCard",
          identifier: "product-103",
          navigatesTo: "product",
          firesRequest: req("GET", "/api/products/103", 200, 1740),
        },
        {
          key: "prod-104",
          label: "4K Webcam",
          component: "ProductCard",
          identifier: "product-104",
          navigatesTo: "product",
          revealedByScroll: true,
          firesRequest: req("GET", "/api/products/104", 200, 4010),
        },
        {
          key: "prod-105",
          label: "Laptop Stand",
          component: "ProductCard",
          identifier: "product-105",
          navigatesTo: "product",
          revealedByScroll: true,
          firesRequest: req("GET", "/api/products/105", 200, 2210),
        },
      ],
      tabs,
    }),
    search: makeScreen({
      ...
      rows: [
        ...
        },
        {
          ...
          label: "Mechanical Keyboard",
          component: "ProductCard",
          identifier: "result-102",
          navigatesTo: "product",
          firesRequest: req("GET", "/api/search?q=keyboard", 200, 980),
        },
      ],
      tabs,
    }),
    product: makeScreen({
      ...
      rows: [
        ...
        },
        {
          ...
          navigatesTo: "cart",
          firesRequest: req("POST", "/api/cart/add", 201, 640, '{"productId":101,"qty":1}'),
        },
        {
          key: "reviews",
          label: "Reviews (214)",
          component: "ReviewsLink",
          identifier: "reviews-link",
          navigatesTo: "product",
          revealedByScroll: true,
        },
      ],
    ...
    cart: makeScreen({
      ...
      rows: [
        {
          key: "cart-item",
          label: "Wireless Headphones — $129.00",
          role: "text",
          component: "CartItem",
          identifier: "cart-item-101",
        },
        {
          key: "checkout",
          label: "Checkout",
          ...
          firesRequest: req("POST", "/api/checkout", 200, 1200),
        },
      ],
      tabs,
    }),
    checkout: makeScreen({
      ...
      rows: [
        ...
        },
        {
          ...
          navigatesTo: "confirmation",
          firesRequest: req("POST", "/api/payments", 200, 2400),
        },
      ],
      tabs,
    }),
    ...
    profile: makeScreen({
      ...
      rows: [
        ...
        },
        {
          ...
          role: "switch",
          component: "NotifToggle",
          identifier: "notif-toggle",
          togglesState: "notifications",
        },
      ],
      tabs,
    }),
