#!/usr/bin/env bash
# Package the silver-v6 LoRA adapter (peft, trained on the free silver-iso 6144 recipe) into ollama.
...
ollama list | grep silver-v6 || true
