#!/usr/bin/env bash
# Package the silver-v7 LoRA adapter (long-context real-harness QLoRA, hybrid flash+xformers attention,
# completion-only masking, 150 steps, trained on a rented A100) into ollama.
