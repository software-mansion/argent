...
- Node.js 18 or later
- A GitHub account with read access to `software-mansion/argent`
...
> If your organisation enforces SSO, click **Configure SSO** next to the token and authorise `software-mansion`.
...
The CLI will:
- Install `@software-mansion/argent` from GitHub Packages into `node_modules`
...
```bash
npx @software-mansion/argent update
```
...
Your GitHub account does not have read access to `software-mansion/argent`, or SSO authorisation is missing. Contact the repository administrator.
