...
Allowed tools and their args (udid is auto-injected, do NOT include it in args):
  ...
  fold:           { posture?: "closed"|"half-open"|"open", angle?: 0-180 }  (one of posture/angle; returns once the new panel takes input, so the next step lands; re-describe after, the panel and its coordinate space change)  [foldable ios sim]
