...
> = {
  ...
  description: `Start recording a new flow, resetting .argent/flows/<name>.yaml to an empty flow and replacing any existing one. Save any top-level \`env\` defaults before this call. Restore them after recording.
