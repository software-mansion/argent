 ...
 * reads it back for its summary, so a hand-edit made mid-recording (a documented
 * workflow) is part of the take even though the in-memory copy only catches up
 * on the next append.
 *
