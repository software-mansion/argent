...
export interface GestureSwipeParams {
  udid: string;
  fromX: number;
  fromY: number;
  toX: number;
...
export interface GestureSwipeServices {
  simulatorServer: SimulatorServerApi;
}

export const iosImpl: PlatformImpl<GestureSwipeServices, GestureSwipeParams, GestureSwipeResult> = {
