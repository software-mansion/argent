...
TV targets are tagged with runtimeKind 'tv' (Apple TV simulators on iOS, Android TV / leanback devices on Android) — interact with those via the tv-* tools (tv-describe / tv-navigate / tv-set-focus / tv-type), not the coordinate/gesture tools.
