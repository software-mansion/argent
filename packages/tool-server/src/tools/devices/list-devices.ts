...
A foldable iOS simulator (the iPhone Duo) carries 'foldable: true'; fold it with the \`fold\` tool. Screenshots, describe and touches follow the panel it renders to.
