...
A DEBUGGER_CDP_REQUEST_TIMEOUT from another debugger tool does not move this answer: the check is the socket, and a runtime that hangs behind an open one still reports "connected". Take the recovery from that tool's own error there, not from this status.`,
    zodSchema,
