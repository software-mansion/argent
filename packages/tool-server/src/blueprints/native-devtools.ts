 ...
 * terminal state without this text, from both its pinned refusal and its
 * measured diagnosis: that reader is authoring a flow, so it names the
 * flow-level remedy (drive by coordinate) instead.
 *
