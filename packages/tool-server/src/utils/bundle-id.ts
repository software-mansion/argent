...
// flag inside `am start -n …` / `pm …`; call sites exec via an argv array or
// shellQuote, so that is defense in depth. Digits are admitted at the head
// because an iOS CFBundleIdentifier may begin with one (`9gag.app`).
