...
| React Native                      | `debugger-component-tree` | React component tree with names, text, testID, and (tap: x,y) — an element scrolled outside the viewport is listed as (off-screen: x,y) and cannot be tapped until you scroll it into view                                                          |
