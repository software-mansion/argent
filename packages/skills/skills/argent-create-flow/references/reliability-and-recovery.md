...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `selector-not-found`, `selector-not-visible`, `selector-scope-unresolved`                                                                                           | nothing matched / everything that matched had a zero-area frame / a `within`/`after`/`next` scope resolved to nothing | **Edit the selector** from the ranked `candidates`. For `-not-visible`, add a `scroll-to` before the step or `await` the element. For `-scope-unresolved`, fix the scope's anchor first — the target was never looked for.                                                                                                                                         |
