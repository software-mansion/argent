...
| `snapshot`   | `- snapshot: home` or `- snapshot: { name: home, maxMismatch: 0.5, cropOn: "Order summary" }`                                                                        | diff a screenshot — or one element's region — against a stored baseline                                                                                         |
