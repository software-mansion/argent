...
| `run`        | `- run: login.yaml`                                                                                                                                                  | execute another flow's steps inline (fragment or e2e); a YAML path resolved relative to the flow file that contains the step (e.g. `../shared/login.yaml`)      |
