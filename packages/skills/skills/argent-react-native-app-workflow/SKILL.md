...
| Locate and act on a target   | `find` tool for specific visible controls; confirm `found: true` before assuming the action ran                                          |
