...
| `notifications`   | **unsupported** - no iOS equivalent; answer the app's dialog instead (to then deliver a test push, use the `push-notification` tool - see `argent-push-notifications`) | `POST_NOTIFICATIONS`                                                                                      |
