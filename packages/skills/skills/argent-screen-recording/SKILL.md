...
- **Unsupported**: Chromium apps, Vega/Fire TV, and remote (`sim-remote:`) simulators. For a single still frame use `screenshot`; for a replayable interaction script use `argent-create-flow` instead of a video.
