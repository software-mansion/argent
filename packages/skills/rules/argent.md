...
- Fold with the `fold` tool (`posture`: closed / half-open / open, or `angle` 0–180). It waits for the device to switch panels and accept input there, and returns the panel and its size.
