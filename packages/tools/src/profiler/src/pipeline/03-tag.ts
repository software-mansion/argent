 ...
 */
import type { EnrichOutput, TagOutput, TaggedComponent } from '../types/pipeline.js';
...
const RECYCLER_PARENT_PATTERN = /^(FlatList|SectionList|VirtualizedList|FlashList|RecyclerListView)/i;
