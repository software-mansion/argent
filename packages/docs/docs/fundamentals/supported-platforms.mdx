...
| ----------------- | ----------------------------------------------------------------------- | ---------------- |
| **iOS**           | Simulators, and physical iPhones/iPads (experimental)                   | Touch / gesture  |
...
Argent also drives a physical iPhone or iPad over a USB cable. The support is experimental and behind the `ios-physical-devices` feature flag. Automation on hardware is scoped to one app at a time, and a subset of the simulator tools is available. See [Physical iOS devices](/docs/features/physical-ios-devices).
