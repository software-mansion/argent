...
Every release on [GitHub](https://github.com/software-mansion/argent/releases) carries the package tarball as an asset, for example `swmansion-argent-0.25.1.tgz`. It is the same file npm serves. Download it and install it globally:

```bash
npm install -g ./swmansion-argent-0.25.1.tgz
argent init
```
