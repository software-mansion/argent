...
pnpm 12.0 to 12.3 stops this command with `ERR_PNPM_IGNORED_BUILDS`. These versions block the build scripts of native dependencies. Do one of these steps:

- Update pnpm to 12.4 or later with `pnpm self-update`.
