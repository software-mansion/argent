...
| -                | `SIM_REMOTE_SESSION` | The name of the session. Each name has its own daemon, so several sessions can run on one computer. See [Sessions and limits](/docs/cloud/reference/sessions#several-sessions-on-one-computer) |
