...
- On Android and Chromium, a screen can hold more elements than one capture carries. The agent then gets a part of the tree and a message that says so. The other platforms have no such limit and send no such message.
