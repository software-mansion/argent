...
- A screen can have very many elements. Argent then shows the first 500 elements. Argent also gives the number of the elements that it does not show. The agent reads a smaller part of the screen to see them.
