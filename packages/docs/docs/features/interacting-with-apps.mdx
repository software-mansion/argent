...
- The clear action is bounded on every target except Chromium, so the agent clears a long field more than once. [Clearing a text field](/docs/reference/tools#clearing-a-text-field) has the limits.
