...
- The comparison of two saved screenshots works on all platforms, also on Chromium, Apple TV and Vega apps.
- A live capture during the comparison works on an iOS simulator, a [physical iPhone](/docs/features/physical-ios-devices), or an Android emulator or device. On other platforms, the agent captures the screenshots first and then compares the saved files.
