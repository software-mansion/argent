...
The agent puts a screenshot in a temporary directory. The system deletes this directory later. Tell the agent where to put the file when you want to keep it. A kept file can be a baseline for a later session.
