...
- The comparison works on an iOS simulator, or an Android emulator or device. It does not work on Chromium, Apple TV or Vega apps. On a [physical iPhone or iPad](/docs/features/physical-ios-devices), the agent captures full-resolution screenshots and compares them on the host instead.
