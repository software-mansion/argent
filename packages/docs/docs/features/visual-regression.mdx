...
Without a target path, the agent leaves the screenshot in the temporary directory of the system. Tell the agent where to put the file when you want to keep it. A kept file can be a baseline for a later session.
