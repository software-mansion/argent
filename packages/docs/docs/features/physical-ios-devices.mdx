...
Argent drives a physical iPhone or iPad over a USB cable. The agent launches the app, reads the screen, taps, swipes and types on the real device, in the same loop it uses on a simulator.
