...
types the text again in small pieces. A step passes when the repair works, with the field
changed by more than the typed text. A step also fails when the repair ran and Argent could
