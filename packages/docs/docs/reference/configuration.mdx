...
| `ARGENT_SCREENSHOT_SCALE`     | `0.25`                               | Scale factor of a captured screenshot on iOS, Android, Apple TV and Vega, between `0` and `1`. A smaller value returns a smaller image. Chromium does not read this variable |
