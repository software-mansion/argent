...
| -------------------------- | --------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `telemetry.enabled`        | global          | restrictive wins | Whether anonymous telemetry is on. Default `true`. Read-only here: use `argent telemetry` to change it                                |
...
| restrictive wins | The more restrictive value wins. Thus a project file cannot turn telemetry on |
...
See [Telemetry and privacy](/docs/reference/telemetry) for the opt-out command.
