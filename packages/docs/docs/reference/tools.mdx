...
| Tool                     | Description                                                                                                                                                         |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `flow-start-recording`   | Start recording a new flow, resetting `.argent/flows/<name>.yaml`. A `requires:` block survives the reset when the tool-server can read and parse the existing file |
