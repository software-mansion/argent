#!/usr/bin/env bash
# Build native-devtools-android APK for Argent. Runnable from any directory.
#
# Bump assets/manifest.json in git when releasing a new helper, then rebuild.
#
# Environment:
#   PREBUILT_ANDROID_DEVTOOLS_APK  if set, copy this path to bin/ instead of building
set -euo pipefail
