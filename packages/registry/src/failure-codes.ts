export const FAILURE_CODES = {
  ...
  ANDROID_SYSTEM_SETTING_FAILED: "ANDROID_SYSTEM_SETTING_FAILED",
  IOS_SYSTEM_SETTING_FAILED: "IOS_SYSTEM_SETTING_FAILED",
  SYSTEM_SETTING_UNSUPPORTED: "SYSTEM_SETTING_UNSUPPORTED",
