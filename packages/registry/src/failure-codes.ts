export const FAILURE_CODES = {
  ...
  HARMONY_HDC_NOT_FOUND: "HARMONY_HDC_NOT_FOUND",
  HARMONY_EMULATOR_NOT_FOUND: "HARMONY_EMULATOR_NOT_FOUND",
  HARMONY_EMULATOR_COMMAND_FAILED: "HARMONY_EMULATOR_COMMAND_FAILED",
  HARMONY_HDC_COMMAND_FAILED: "HARMONY_HDC_COMMAND_FAILED",
  HARMONY_DEVICE_ID_INVALID: "HARMONY_DEVICE_ID_INVALID",
  HARMONY_DEVICE_UNREACHABLE: "HARMONY_DEVICE_UNREACHABLE",
  HARMONY_SHELL_NO_STATUS: "HARMONY_SHELL_NO_STATUS",
  HARMONY_FILE_TRANSFER_FAILED: "HARMONY_FILE_TRANSFER_FAILED",
  HARMONY_UITEST_FAILED: "HARMONY_UITEST_FAILED",
  HARMONY_DISPLAY_UNREADABLE: "HARMONY_DISPLAY_UNREADABLE",
  HARMONY_SCREEN_OFF: "HARMONY_SCREEN_OFF",
  HARMONY_ABILITY_START_FAILED: "HARMONY_ABILITY_START_FAILED",
  HARMONY_ABILITY_STOP_FAILED: "HARMONY_ABILITY_STOP_FAILED",
  ...
  NATIVE_DEVTOOLS_SOCKET_NOT_PUBLISHED: "NATIVE_DEVTOOLS_SOCKET_NOT_PUBLISHED",
  NATIVE_DEVTOOLS_ATTACH_FAILED: "NATIVE_DEVTOOLS_ATTACH_FAILED",
  NATIVE_DEVTOOLS_ATTACH_LOST: "NATIVE_DEVTOOLS_ATTACH_LOST",
  ...
  JS_RUNTIME_PAUSED: "JS_RUNTIME_PAUSED",
  ...
  BOOT_HARMONY_INSTANCE_NOT_FOUND: "BOOT_HARMONY_INSTANCE_NOT_FOUND",
  BOOT_HARMONY_TARGET_LIST_FAILED: "BOOT_HARMONY_TARGET_LIST_FAILED",
  BOOT_HARMONY_STOP_FAILED: "BOOT_HARMONY_STOP_FAILED",
  BOOT_HARMONY_STOP_TIMEOUT: "BOOT_HARMONY_STOP_TIMEOUT",
  BOOT_HARMONY_MANAGER_EXITED: "BOOT_HARMONY_MANAGER_EXITED",
  BOOT_HARMONY_START_FAILED: "BOOT_HARMONY_START_FAILED",

  /**
   * External device providers
   * @see [external-devices.ts](../../tool-server/src/utils/external-devices.ts)
   */
  EXTERNAL_DEVICE_CAPABILITY_DENIED: "EXTERNAL_DEVICE_CAPABILITY_DENIED",
  EXTERNAL_DEVICE_ENDPOINT_FORBIDDEN: "EXTERNAL_DEVICE_ENDPOINT_FORBIDDEN",
  EXTERNAL_DEVICE_LIFECYCLE_REFUSED: "EXTERNAL_DEVICE_LIFECYCLE_REFUSED",
  EXTERNAL_DEVICE_REVOCATION_INCOMPLETE: "EXTERNAL_DEVICE_REVOCATION_INCOMPLETE",
  EXTERNAL_DEVICE_UNAVAILABLE: "EXTERNAL_DEVICE_UNAVAILABLE",
} as const;
