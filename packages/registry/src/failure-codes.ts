export const FAILURE_CODES = {
  ...
  HTTP_DEPENDENCY_EXECUTION_MISSING: "HTTP_DEPENDENCY_EXECUTION_MISSING",
  HTTP_UNSUPPORTED_OPERATION: "HTTP_UNSUPPORTED_OPERATION",
  HTTP_PLATFORM_NOT_IMPLEMENTED: "HTTP_PLATFORM_NOT_IMPLEMENTED",
  HTTP_TOOL_EXECUTION_UNCLASSIFIED: "HTTP_TOOL_EXECUTION_UNCLASSIFIED",
  ...
  INSTALL_REGISTRY_CHECK_FAILED: "INSTALL_REGISTRY_CHECK_FAILED",
  INSTALL_INIT_TRIGGERED_UPDATE_FAILED: "INSTALL_INIT_TRIGGERED_UPDATE_FAILED",
  INSTALL_SKILLS_NPX_FAILED: "INSTALL_SKILLS_NPX_FAILED",
  INSTALL_RULES_AGENTS_COPY_FAILED: "INSTALL_RULES_AGENTS_COPY_FAILED",
