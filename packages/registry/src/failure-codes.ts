export const FAILURE_CODES = {
  ...
  // screen-recording-start / screen-recording-stop. Platform-specific stages
  // ride the shared codes via failure_stage (ios_* / android_*), mirroring how
  // the native-profiler pair classifies its capture lifecycle.
