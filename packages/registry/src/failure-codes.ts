export const FAILURE_CODES = {
  ...
  PHYSICAL_IOS_AUTOMATION_FACTORY_OPTIONS_MISSING:
    "PHYSICAL_IOS_AUTOMATION_FACTORY_OPTIONS_MISSING",
  PHYSICAL_IOS_AUTOMATION_WRONG_DEVICE: "PHYSICAL_IOS_AUTOMATION_WRONG_DEVICE",
  PHYSICAL_IOS_AUTOMATION_DEVICE_DETAILS_FAILED:
    "PHYSICAL_IOS_AUTOMATION_DEVICE_DETAILS_FAILED",
  PHYSICAL_IOS_AUTOMATION_SIGNING_TEAM_NOT_FOUND:
    "PHYSICAL_IOS_AUTOMATION_SIGNING_TEAM_NOT_FOUND",
  PHYSICAL_IOS_AUTOMATION_WDA_BUILD_FAILED: "PHYSICAL_IOS_AUTOMATION_WDA_BUILD_FAILED",
  PHYSICAL_IOS_AUTOMATION_WDA_SESSION_FAILED:
    "PHYSICAL_IOS_AUTOMATION_WDA_SESSION_FAILED",
  PHYSICAL_IOS_AUTOMATION_COMMAND_FAILED: "PHYSICAL_IOS_AUTOMATION_COMMAND_FAILED",

  DEVICE_LOG_SESSION_FACTORY_OPTIONS_MISSING: "DEVICE_LOG_SESSION_FACTORY_OPTIONS_MISSING",
  DEVICE_LOG_SESSION_ALREADY_ACTIVE: "DEVICE_LOG_SESSION_ALREADY_ACTIVE",
  DEVICE_LOG_SESSION_NOT_ACTIVE: "DEVICE_LOG_SESSION_NOT_ACTIVE",
  DEVICE_LOG_SESSION_START_FAILED: "DEVICE_LOG_SESSION_START_FAILED",
