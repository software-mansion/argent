export const FAILURE_CODES = {
  ...
  KEYBOARD_CLEAR_NO_EDITABLE_FOCUS: "KEYBOARD_CLEAR_NO_EDITABLE_FOCUS",
  KEYBOARD_CLEAR_READ_ONLY: "KEYBOARD_CLEAR_READ_ONLY",
  KEYBOARD_CLEAR_FIELD_TOO_LONG: "KEYBOARD_CLEAR_FIELD_TOO_LONG",
  KEYBOARD_CLEAR_INEFFECTIVE: "KEYBOARD_CLEAR_INEFFECTIVE",
  KEYBOARD_CLEAR_INTERRUPTED: "KEYBOARD_CLEAR_INTERRUPTED",
  KEYBOARD_CLEAR_FOCUS_LOST: "KEYBOARD_CLEAR_FOCUS_LOST",
  KEYBOARD_CLEAR_UNSUPPORTED_TARGET: "KEYBOARD_CLEAR_UNSUPPORTED_TARGET",
  KEYBOARD_TEXT_REFUSED: "KEYBOARD_TEXT_REFUSED",
